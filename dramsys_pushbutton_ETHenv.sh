...
./install/bin/gvsoc --target=occamy --binary third_party/occamy/target/sim/sw/host/apps/offload/build/offload-test.elf --debug-binary third_party/occamy/target/sim/sw/device/apps/blas/test/build/test.elf run --trace=chip/soc/quadrant_0/cluster_0/redmule
