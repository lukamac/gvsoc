...
# ./install/bin/gvsoc --target=occamy --binary examples/occamy/offload-multi_cluster.elf --debug-binary third_party/occamy/target/sim/sw/device/apps/blas/gemm/build/gemm.elf run
# make snitch_pdk_preparation
# ./install/bin/gvsoc --target=occamy --binary examples/occamy/offload-multi_cluster.elf --debug-binary third_party/snitch_cluster/target/snitch_cluster/sw/apps/redmule/build/redmule.elf run
